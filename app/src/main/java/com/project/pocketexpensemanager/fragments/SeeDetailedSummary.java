...
public class SeeDetailedSummary extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.detailed_summary, container, false);
        ...
        SimpleCursorAdapter transactionSca = new SimpleCursorAdapter(getActivity(), R.layout.detailed_summary_item,
                expenseCursor, adapterColViews, adapterRowViews, 0);
        transactionSca.setDropDownViewResource(R.layout.detailed_summary_item);
